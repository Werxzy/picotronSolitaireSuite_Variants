--[[pod_format="raw",created="2024-03-25 02:14:11",modified="2024-03-26 23:51:30",revision=388]]
...
function game_info()
	return {
		...
		rules = {
			...
			"\tTo win, create an ordered stack for each of the 4 suits ranging from K to 1",
		}
	}
end
